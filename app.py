...
APP_VERSION = os.environ.get("APP_VERSION", "1.8.5")  # shown in dashboard + API, so live version is always checkable
...
FAVICON_B64 = ""
ICO_APPLE = "https://media.base44.com/images/public/6aa89406a2d9664f56be6f5c/904de8f7d_crew-icon-180.png"
ICO_ANDROID = "https://media.base44.com/images/public/6aa89406a2d9664f56be6f5c/333b46d4a_crew-icon-192.png"
ICO_SHARE = "https://media.base44.com/images/public/6aa89406a2d9664f56be6f5c/0ee478307_crew-icon-512.png"
...
<link rel="icon" type="image/png" sizes="192x192" href="{{ico_android}}">
<link rel="apple-touch-icon" href="{{ico_apple}}">
<meta property="og:type" content="website">
<meta property="og:site_name" content="The Crew · Signal Desk">
<meta property="og:title" content="The Crew · Signal Desk">
<meta property="og:description" content="Four AI agents. One desk. Full consensus or no trade — designed by Dezlin Oliver.">
<meta property="og:image" content="{{ico_share}}">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="The Crew · Signal Desk">
<meta name="twitter:description" content="Four AI agents. One desk. Full consensus or no trade — designed by Dezlin Oliver.">
<meta name="twitter:image" content="{{ico_share}}">
...
def dashboard():
    return (DASHBOARD
            .replace("{{logo}}", LOGO_PNG_B64)
            .replace("{{favicon}}", FAVICON_B64)
            .replace("{{ico_android}}", ICO_ANDROID)
            .replace("{{ico_apple}}", ICO_APPLE)
            .replace("{{ico_share}}", ICO_SHARE))
